...
var GameLoader=(function(){
	function GameLoader(){
		this.moduleFileName="maingame.js";
		Laya.init(1136,640);
		console.log("准备加载子模块");
		Laya.loader.load("js/"+this.moduleFileName,Handler.create(this,this.onLoaded),null,"text");
	}

	__class(GameLoader,'GameLoader');
	var __proto=GameLoader.prototype;
	__proto.onLoaded=function(data){
		window.eval(data+"//# sourceURL="+this.moduleFileName );
		var hellowWorld=new core.HelloWorld();
	}
...
var Loader=(function(_super){
	...
	*/
	...
	Loader.imgCache={};
	__static(Loader,
	['typeMap',function(){return this.typeMap={"png":"image","jpg":"image","jpeg":"image","txt":"text","json":"json","xml":"xml","als":"atlas","atlas":"atlas","mp3":"sound","ogg":"sound","wav":"sound","part":"json","fnt":"font"};}
	]);
	return Loader;
})(EventDispatcher)
